...
Описание:
Девятая версия раздела "Клиенты".

Что нового:
- Проведена небольшая чистка кода.
- Добавлены вспомогательные функции для уменьшения повторений.
- Улучшена читаемость кода перед версией v1.0.
...
Эта версия сохраняется как подготовительная версия перед v1.0.
Она показывает момент, когда функционал уже есть,
а код немного приведён в порядок.
"""

...
Описание:
Седьмая версия раздела "Клиенты".

Что нового:
- У клиента появились контактные данные:
  - телефон;
  - Instagram;
  - email.
- Добавление клиента теперь проходит в несколько шагов.
- Клиенты сохраняются в clients.txt вместе с контактами.

Что умеет:
- Открывать раздел «Клиенты».
- Показывать меню раздела.
- Добавлять клиента с контактами.
...
- Телефон, Instagram и email пока нельзя изменить отдельно.
...
в котором клиент хранит не только имя, но и контактные данные.
"""

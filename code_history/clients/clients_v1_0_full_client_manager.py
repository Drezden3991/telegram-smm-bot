...
Описание:
Первая полноценная версия раздела "Клиенты".

Что нового:
- Добавлена отдельная карточка клиента.
- Добавлена кнопка «👤 Карточка клиента».
- Раздел получил статус полноценного менеджера клиентов.
...
- Показывать отдельную карточку клиента.
- Удалять клиента.
...
- Нет связи с идеями, постами и контент-планом.

Почему версия сохранена:
Эта версия сохраняется как первая полноценная стабильная версия
раздела «Клиенты» перед переходом к развитию других разделов проекта.
"""
